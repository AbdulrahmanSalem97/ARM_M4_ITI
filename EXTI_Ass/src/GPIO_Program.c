...
void GPIO_void_SetPinType(u8 copy_u8GPIOX ,u8 copy_u8PIN,u8 copy_PinType)
{
	switch(copy_u8GPIOX)
		...
		case (GPIOA_):
					...
					case (PULL_UP):       Set_Bit(GPIOA_REG->PUPDR,(copy_u8PIN*2));
										  Clr_Bit(GPIOA_REG->PUPDR,(copy_u8PIN*2+1));break;
					case (PULL_DOWN):     Clr_Bit(GPIOA_REG->PUPDR,(copy_u8PIN*2));
					  	  	  	  	  	  Set_Bit(GPIOA_REG->PUPDR,(copy_u8PIN*2+1));break;
					default:break;
					}
					 break;
		case (GPIOB_):
					...
					case (PULL_UP):       Set_Bit(GPIOB_REG->PUPDR,(copy_u8PIN*2));
										  Clr_Bit(GPIOB_REG->PUPDR,(copy_u8PIN*2+1));break;
					case (PULL_DOWN):     Clr_Bit(GPIOB_REG->PUPDR,(copy_u8PIN*2));
					  	  	  	  	  	  Set_Bit(GPIOB_REG->PUPDR,(copy_u8PIN*2+1));break;
					default:break;
					}
				    break;
		case (GPIOC_):
					...
					case (PULL_UP):       Set_Bit(GPIOC_REG->PUPDR,(copy_u8PIN*2));
										  Clr_Bit(GPIOC_REG->PUPDR,(copy_u8PIN*2+1));break;
					case (PULL_DOWN):     Clr_Bit(GPIOC_REG->PUPDR,(copy_u8PIN*2));
					  	  	  	  	  	  Set_Bit(GPIOC_REG->PUPDR,(copy_u8PIN*2+1));break;
					default:break;
					}
					break;
